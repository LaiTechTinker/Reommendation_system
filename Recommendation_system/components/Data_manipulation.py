...
class DataTransformation:
  def __init__(self,data_ingest_artifact:DataIngestionArtifact,data_transformation_config:DataTransformationConfig,data_validation_artifact:DataValidationArtifact):
  ...
  def load_data(self,file_path)->pd.DataFrame:
    ...
    df["crew"]=df["crew"].apply(director_get)
