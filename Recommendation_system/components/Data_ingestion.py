...
from Recommendation_system.entity.artifact_entity import DataIngestionArtifact
from Recommendation_system.exception import RecomException
from Recommendation_system.logger import logging
from Recommendation_system.data_acess.Recom import DataAccess
Access = DataAccess()
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            dataframe = Access.get_data_from_collection()
